...
/**
 * Defines the attributes which all implementation classes have to implement.
 * 
...
public interface AttributesContract
{
   ...
   /**
    * Returns the directory in which service files are created.
    * @return the value.
    */
   public String getServiceDir();

   /**
    * Sets the directory in which service files are created.
    * @param tempDir the directory.
    */
   public void setServiceDir(String tempDir);
