...
import org.jboss.shrinkwrap.descriptor.impl.resourceadapters10.AdminObjectTypeImpl;
...
public class AdminObjectsTypeImpl<T> implements Child<T>, AdminObjectsType<T>
{
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: AdminObjectsType ElementName: resourceadapters:admin-objectType ElementType : admin-object
