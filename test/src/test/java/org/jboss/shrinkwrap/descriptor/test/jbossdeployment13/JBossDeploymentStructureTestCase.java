 ...
 */
package org.jboss.shrinkwrap.descriptor.test.jbossdeployment13;
...
public class JBossDeploymentStructureTestCase {
    ...
    public void testGeneratedXml() throws Exception {
        final JBossDeploymentStructureDescriptor jbossDeployStructur = create()
            ...
            .earExclusionsCascadedToSubdeployments(false)
        ...
        final String jbossStructOriginal = getResourceContents("src/test/resources/test-jboss-deployment-structure13.xml");
