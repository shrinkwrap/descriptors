...
public class PersistenceDescriptorEclipseLinkTestCase
{
   ...
   {
//      String desc = create().getOrCreatePersistenceUnit().provider(ProviderType.ECLIPSE_LINK).showSql().exportAsString();
//   
...
//            "no-value-should-be-added-mode-unsupported");
   ...
   private void shouldBeAbleSetSchemaGenerationModeEclipseLink(String generationMode,
...
//            expectedValue);
   ...
   private void shouldBeAbleSetSchemaGenerationMode(String providerType, String generationMode,
         String expectedName, String expectedValue) throws Exception
   {
//      String desc = create().getOrCreatePersistenceUnit().provider(providerType).schemaGenerationMode(generationMode).exportAsString();
//   
