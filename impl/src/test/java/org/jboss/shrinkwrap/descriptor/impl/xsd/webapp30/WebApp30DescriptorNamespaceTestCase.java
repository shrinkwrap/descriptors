...
public class WebApp30DescriptorNamespaceTestCase
{
   ...
   {
      final String app = create().setVersion("3.0").addDefaultNamespaces().removeAllNamespaces().exportAsString();
   ...
   public void testAddNamespace() throws Exception
   {
      ...
      final String app3 = create().addNamespace("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance")
