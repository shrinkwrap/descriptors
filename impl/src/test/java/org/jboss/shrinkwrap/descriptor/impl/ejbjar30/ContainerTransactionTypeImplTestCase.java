...
public class ContainerTransactionTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      ContainerTransactionType<TestDescriptorImpl> type = new ContainerTransactionTypeImpl<TestDescriptorImpl>(
            provider, "container-transactionType", provider.getRootNode());
