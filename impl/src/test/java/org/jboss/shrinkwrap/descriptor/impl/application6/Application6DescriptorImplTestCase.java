...
public class Application6DescriptorImplTestCase
{
   ...
   {
      String desc = create()
                     .module().setConnector(moduleName).up()
                     .exportAsString();
   ...
   {
      String desc = create()
                     .securityRole().setRoleName(moduleName).up()
                     .exportAsString();
   ...
   {
      String desc = create()
                     .securityRole().setRoleName(moduleName).setDescription(description).up()
                     .exportAsString();
