...
public class MessageDestinationRefTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      MessageDestinationRefType<TestDescriptorImpl> type = new MessageDestinationRefTypeImpl<TestDescriptorImpl>(
            provider, "message-destination-refType", provider.getRootNode());
