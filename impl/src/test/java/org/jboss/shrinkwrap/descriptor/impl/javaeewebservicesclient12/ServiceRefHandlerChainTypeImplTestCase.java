...
public class ServiceRefHandlerChainTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      ServiceRefHandlerChainType<TestDescriptorImpl> type = new ServiceRefHandlerChainTypeImpl<TestDescriptorImpl>(
            provider, "service-ref_handler-chainType", provider.getRootNode());
