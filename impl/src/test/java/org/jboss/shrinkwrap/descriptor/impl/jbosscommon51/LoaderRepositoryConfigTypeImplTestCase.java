...
public class LoaderRepositoryConfigTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      LoaderRepositoryConfigType<TestDescriptorImpl> type = new LoaderRepositoryConfigTypeImpl<TestDescriptorImpl>(
            provider, "loader-repository-configType", provider.getRootNode());
