...
public class WebApp30DescriptorAttributeGroupTestCase
{
   ...
   {
      final WebApp30Descriptor webApp = create().servlet().setDescription("Description1")
   ...
   {
      final WebApp30Descriptor webApp = create().filter().setDisplayName("displayName1").setDisplayName("displayName2")
            .up();
   ...
   {
      final WebApp30Descriptor webApp = create().filter().icon().setLargeIcon("largeIcon1").up().icon().setSmallIcon(
            "smallIcon2").up().up();
