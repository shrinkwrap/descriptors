...
public class ActivationConfigPropertyTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      ActivationConfigPropertyType<TestDescriptorImpl> type = new ActivationConfigPropertyTypeImpl<TestDescriptorImpl>(
            provider, "activation-config-propertyType", provider.getRootNode());
