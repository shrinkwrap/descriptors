...
public class LocaleEncodingMappingTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      LocaleEncodingMappingType<TestDescriptorImpl> type = new LocaleEncodingMappingTypeImpl<TestDescriptorImpl>(
            provider, "locale-encoding-mappingType", provider.getRootNode());
