...
public class Persistence20DescriptorImplTestCase
{
   ...
   {
      String desc = create().persistenceUnit().setName(name2).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setName(name2).up()
                     .exportAsString();
   ...
   public void shouldBeAbleToAddClasses() throws Exception
   {
      String desc = create().getPersistenceUnitList().get(0)
         .setClazzList(PersistenceDescriptor.class.getName(), PersistenceDescriptor.class.getName()).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setDescription(name).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setExcludeUnlistedClasses(true).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setExcludeUnlistedClasses(false).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setJtaDataSource(name).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setJarFile(name).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setJarFileList(name, name2).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setMappingFile(name).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setMappingFileList(name, name2).up()
                     .exportAsString();
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setTransactionType(PersistenceUnitTransactionType._JTA).up()
                     .exportAsString();

      assertXPath(desc, "/persistence/persistence-unit/@transaction-type", PersistenceUnitTransactionType._JTA.toString());
   }
   ...
   public void shouldBeAbleToAddProperties() throws Exception
   {
      String desc = create().getPersistenceUnitList().get(0)
         .properties()
            .property().setName(name).setValue(name2).up()
            .property().setName(name2).setValue(name).up()
            .up().up().exportAsString();
   ...
   {
      Persistence20Descriptor def = create().getPersistenceUnitList().get(0)
         .properties()
            .property().setName(name).setValue(name2).up()
            .property().setName(name2).setValue(name).up()
         .up().up();

      List<org.jboss.shrinkwrap.descriptor.api.persistence20.Property<Properties<PersistenceUnit<Persistence20Descriptor>>>> props = def.getPersistenceUnitList().get(0).properties().getPropertyList();
...
//   }
   ...
   {
      String desc = create().getPersistenceUnitList().get(0).setValidationMode(PersistenceUnitValidationModeType._AUTO).up()
                     .exportAsString();

      assertXPath(desc, "/persistence/persistence-unit/validation-mode", PersistenceUnitValidationModeType._AUTO.toString());
   }
...
//   }
   ...
   private Persistence20Descriptor create()
   {
      return Descriptors.create(Persistence20Descriptor.class)
               .persistenceUnit().setName(name).up();
   }
}
