...
public class RelationshipRoleSourceTypeImplTestCase
{
   ...
   public void testNullArg() throws Exception
   {
      ...
      RelationshipRoleSourceType<TestDescriptorImpl> type = new RelationshipRoleSourceTypeImpl<TestDescriptorImpl>(
            provider, "relationship-role-sourceType", provider.getRootNode());
