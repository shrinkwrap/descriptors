...
public class MyWebAppTestCase
{
   ...
   {
      final String webApp = Descriptors.create(WebAppDescriptor.class).description("description").up()
            ...
            .absoluteOrdering().name("name1").name("name2").up().securityConstraint().displayName("displayName")
            .authConstraint().description("description").roleName("manager").up().up()
