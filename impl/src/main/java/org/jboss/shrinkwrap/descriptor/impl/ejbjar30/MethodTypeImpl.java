...
public class MethodTypeImpl<T> implements Child<T>, MethodType<T> {
	...
	public MethodIntfType getMethodIntf() {
		return MethodIntfType.getFromStringValue(childNode
				.textValue("method-intf"));
	}
	...
	public MethodParamsType<MethodType<T>> methodParams() {
		...
		MethodParamsType<MethodType<T>> methodParams = new MethodParamsTypeImpl<MethodType<T>>(
