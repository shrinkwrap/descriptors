 ...
 * 
 * 
 * The user-data-constraintType is used to indicate how data communicated
 ...
 * 
 */
public class UserDataConstraintTypeImpl<T> implements Child<T>,
	...
	// -------------------------------------------------------------------------------------||
	public UserDataConstraintType<T> setTransportGuarantee(
	...
	public TransportGuaranteeType getTransportGuarantee() {
		return TransportGuaranteeType.getFromStringValue(childNode
				.textValue("transport-guarantee"));
	}
