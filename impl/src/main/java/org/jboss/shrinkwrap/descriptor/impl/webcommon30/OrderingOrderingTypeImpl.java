 ...
 * 
 * 
 * This element contains a sequence of "name" elements, each of which refers to
 * an application configuration resource by the "name" declared on its web.xml
 * fragment. This element can also contain a single "others" element which
 * specifies that this document comes before or after other documents within the
 * application. See section 8.2.2 of the specification for details.
 * 
 * 
 * 
 */
public class OrderingOrderingTypeImpl<T> implements Child<T>,
		OrderingOrderingType<T> {
	// -------------------------------------------------------------------------------------||
	// Instance Members
	// --------------------------------------------------------------------||
	// -------------------------------------------------------------------------------------||
