 ...
 */
public class Persistence20DescriptorImpl extends NodeProviderImplBase implements
		DescriptorNamespace<Persistence20Descriptor>, Persistence20Descriptor {
	// -------------------------------------------------------------------------------------||
	// Instance Members
	// --------------------------------------------------------------------||
	// -------------------------------------------------------------------------------------||
	...
	public PersistenceUnit<Persistence20Descriptor> persistenceUnit() {
		return new PersistenceUnitImpl<Persistence20Descriptor>(this,
	...
	public List<PersistenceUnit<Persistence20Descriptor>> getPersistenceUnitList() {
		...
		for (Node node : nodeList) {
			PersistenceUnit<Persistence20Descriptor> type = new PersistenceUnitImpl<Persistence20Descriptor>(
					this, "persistence-unit", model, node);
			list.add(type);
		}
		return list;
	}
