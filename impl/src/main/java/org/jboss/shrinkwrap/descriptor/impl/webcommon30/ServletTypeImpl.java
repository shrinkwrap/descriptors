 ...
 * 
 * 
 * The servletType is used to declare a servlet. It contains the declarative
 * data of a servlet. If a jsp-file is specified and the load-on-startup element
...
public class ServletTypeImpl<T> implements Child<T>, ServletType<T> {
	...
	public List<IconType<ServletType<T>>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<ServletType<T>> type = new IconTypeImpl<ServletType<T>>(
	...
	public ParamValueType<ServletType<T>> initParam() {
		return new ParamValueTypeImpl<ServletType<T>>(this, "init-param",
				childNode);
	}
	...
	public List<ParamValueType<ServletType<T>>> getInitParamList() {
		...
		for (Node node : nodeList) {
			ParamValueType<ServletType<T>> type = new ParamValueTypeImpl<ServletType<T>>(
	...
	public RunAsType<ServletType<T>> runAs() {
		...
		RunAsType<ServletType<T>> runAs = new RunAsTypeImpl<ServletType<T>>(
	...
	public SecurityRoleRefType<ServletType<T>> securityRoleRef() {
		return new SecurityRoleRefTypeImpl<ServletType<T>>(this,
	...
	public List<SecurityRoleRefType<ServletType<T>>> getSecurityRoleRefList() {
		...
		for (Node node : nodeList) {
			SecurityRoleRefType<ServletType<T>> type = new SecurityRoleRefTypeImpl<ServletType<T>>(
	...
	public MultipartConfigType<ServletType<T>> multipartConfig() {
		...
		MultipartConfigType<ServletType<T>> multipartConfig = new MultipartConfigTypeImpl<ServletType<T>>(
				this, "multipart-config", childNode, node);
