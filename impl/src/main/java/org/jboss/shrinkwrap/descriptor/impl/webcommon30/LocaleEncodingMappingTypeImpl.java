 ...
 * 
 * 
 * The locale-encoding-mapping contains locale name and encoding name. The
 * locale name must be either "Language-code", such as "ja", defined by ISO-639
 * or "Language-code_Country-code", such as "ja_JP". "Country code" is defined
 * by ISO-3166.
 * 
 * 
 * 
 */
public class LocaleEncodingMappingTypeImpl<T> implements Child<T>,
