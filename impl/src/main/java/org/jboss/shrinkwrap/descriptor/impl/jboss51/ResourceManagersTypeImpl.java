 ...
 * 
 */
public class ResourceManagersTypeImpl<T> implements Child<T>,
	...
	public ResourceManagerType<ResourceManagersType<T>> resourceManager() {
		return new ResourceManagerTypeImpl<ResourceManagersType<T>>(this,
				"resource-manager", childNode);
	}
	...
	public List<ResourceManagerType<ResourceManagersType<T>>> getResourceManagerList() {
		...
		for (Node node : nodeList) {
			ResourceManagerType<ResourceManagersType<T>> type = new ResourceManagerTypeImpl<ResourceManagersType<T>>(
					this, "resource-manager", childNode, node);
			list.add(type);
		}
		return list;
	}
