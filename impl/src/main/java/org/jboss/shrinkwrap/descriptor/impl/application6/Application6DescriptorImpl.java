 ...
 */
public class Application6DescriptorImpl extends NodeProviderImplBase implements
		DescriptorNamespace<Application6Descriptor>, Application6Descriptor {
	// -------------------------------------------------------------------------------------||
	// Instance Members
	// --------------------------------------------------------------------||
	// -------------------------------------------------------------------------------------||
	...
	// isComplexType: false maxOccurs: - isAttribute: false
	// -------------------------------------------------------------------------------------||
	public Application6Descriptor setInitializeInOrder(
	...
	public GenericBooleanType getInitializeInOrder() {
		return GenericBooleanType.getFromStringValue(model
				.textValue("initialize-in-order"));
	}
	...
	public List<ModuleType<Application6Descriptor>> getModuleList() {
		...
		for (Node node : nodeList) {
			ModuleType<Application6Descriptor> type = new ModuleTypeImpl<Application6Descriptor>(
	...
	public SecurityRoleType<Application6Descriptor> securityRole() {
		return new SecurityRoleTypeImpl<Application6Descriptor>(this,
				"security-role", model);
	}
	...
	public List<SecurityRoleType<Application6Descriptor>> getSecurityRoleList() {
		...
		for (Node node : nodeList) {
			SecurityRoleType<Application6Descriptor> type = new SecurityRoleTypeImpl<Application6Descriptor>(
	...
	public EnvEntryType<Application6Descriptor> envEntry() {
		return new EnvEntryTypeImpl<Application6Descriptor>(this, "env-entry",
				model);
	}
	...
	public List<EnvEntryType<Application6Descriptor>> getEnvEntryList() {
		...
		for (Node node : nodeList) {
			EnvEntryType<Application6Descriptor> type = new EnvEntryTypeImpl<Application6Descriptor>(
	...
	public EjbRefType<Application6Descriptor> ejbRef() {
		return new EjbRefTypeImpl<Application6Descriptor>(this, "ejb-ref",
				model);
	}
	...
	public List<EjbRefType<Application6Descriptor>> getEjbRefList() {
		...
		for (Node node : nodeList) {
			EjbRefType<Application6Descriptor> type = new EjbRefTypeImpl<Application6Descriptor>(
	...
	public EjbLocalRefType<Application6Descriptor> ejbLocalRef() {
		return new EjbLocalRefTypeImpl<Application6Descriptor>(this,
				"ejb-local-ref", model);
	}
	...
	public List<EjbLocalRefType<Application6Descriptor>> getEjbLocalRefList() {
		...
		for (Node node : nodeList) {
			EjbLocalRefType<Application6Descriptor> type = new EjbLocalRefTypeImpl<Application6Descriptor>(
	...
	public ResourceRefType<Application6Descriptor> resourceRef() {
		return new ResourceRefTypeImpl<Application6Descriptor>(this,
				"resource-ref", model);
	}
	...
	public List<ResourceRefType<Application6Descriptor>> getResourceRefList() {
		...
		for (Node node : nodeList) {
			ResourceRefType<Application6Descriptor> type = new ResourceRefTypeImpl<Application6Descriptor>(
	...
	public ResourceEnvRefType<Application6Descriptor> resourceEnvRef() {
		return new ResourceEnvRefTypeImpl<Application6Descriptor>(this,
	...
	public List<ResourceEnvRefType<Application6Descriptor>> getResourceEnvRefList() {
		...
		for (Node node : nodeList) {
			ResourceEnvRefType<Application6Descriptor> type = new ResourceEnvRefTypeImpl<Application6Descriptor>(
	...
	public MessageDestinationRefType<Application6Descriptor> messageDestinationRef() {
		return new MessageDestinationRefTypeImpl<Application6Descriptor>(this,
	...
	public PersistenceContextRefType<Application6Descriptor> persistenceContextRef() {
		return new PersistenceContextRefTypeImpl<Application6Descriptor>(this,
	...
	public PersistenceUnitRefType<Application6Descriptor> persistenceUnitRef() {
		return new PersistenceUnitRefTypeImpl<Application6Descriptor>(this,
	...
	public MessageDestinationType<Application6Descriptor> messageDestination() {
		return new MessageDestinationTypeImpl<Application6Descriptor>(this,
	...
	public DataSourceType<Application6Descriptor> dataSource() {
		return new DataSourceTypeImpl<Application6Descriptor>(this,
				"data-source", model);
	}
	...
	public List<DataSourceType<Application6Descriptor>> getDataSourceList() {
		...
		for (Node node : nodeList) {
			DataSourceType<Application6Descriptor> type = new DataSourceTypeImpl<Application6Descriptor>(
	...
	public List<IconType<Application6Descriptor>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<Application6Descriptor> type = new IconTypeImpl<Application6Descriptor>(
