 ...
 * 
 * 
 * The jsp-property-groupType is used to group a number of files so they can be
 * given global property information. All files so described are deemed to be
 * JSP files. The following additional properties can be described:
 * 
 * - Control whether EL is ignored. - Control whether scripting elements are
 * invalid. - Indicate pageEncoding information. - Indicate that a resource is a
 * JSP document (XML). - Prelude and Coda automatic includes. - Control whether
 * the character sequence #{ is allowed when used as a String literal. - Control
 * whether template text containing only whitespaces must be removed from the
 * response output. - Indicate the default contentType information. - Indicate
 * the default buffering model for JspWriter - Control whether error should be
 * raised for the use of undeclared namespaces in a JSP page.
 * 
 * 
 * 
 */
public class JspPropertyGroupTypeImpl<T> implements Child<T>,
	...
	public IconType<JspPropertyGroupType<T>> icon() {
		return new IconTypeImpl<JspPropertyGroupType<T>>(this, "icon",
				childNode);
	}
	...
	public List<IconType<JspPropertyGroupType<T>>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<JspPropertyGroupType<T>> type = new IconTypeImpl<JspPropertyGroupType<T>>(
	...
	// isComplexType: false maxOccurs: - isAttribute: false
	// -------------------------------------------------------------------------------------||
	public JspPropertyGroupType<T> setDeferredSyntaxAllowedAsLiteral(
			Boolean deferredSyntaxAllowedAsLiteral) {
		childNode.getOrCreate("deferred-syntax-allowed-as-literal").text(
	...
	public Boolean isDeferredSyntaxAllowedAsLiteral() {
		return Strings.isTrue(childNode
				.textValue("deferred-syntax-allowed-as-literal"));
	}
	...
	// isComplexType: false maxOccurs: - isAttribute: false
	// -------------------------------------------------------------------------------------||
	public JspPropertyGroupType<T> setTrimDirectiveWhitespaces(
			Boolean trimDirectiveWhitespaces) {
		childNode.getOrCreate("trim-directive-whitespaces").text(
	...
	public Boolean isTrimDirectiveWhitespaces() {
		return Strings
				.isTrue(childNode.textValue("trim-directive-whitespaces"));
	}
	...
	// isComplexType: false maxOccurs: - isAttribute: false
	// -------------------------------------------------------------------------------------||
	public JspPropertyGroupType<T> setDefaultContentType(
	...
	// isComplexType: false maxOccurs: - isAttribute: false
	// -------------------------------------------------------------------------------------||
	public JspPropertyGroupType<T> setErrorOnUndeclaredNamespace(
			Boolean errorOnUndeclaredNamespace) {
		childNode.getOrCreate("error-on-undeclared-namespace").text(
	...
	public Boolean isErrorOnUndeclaredNamespace() {
		return Strings.isTrue(childNode
				.textValue("error-on-undeclared-namespace"));
	}
