 ...
 * 
 * Original Documentation: The loader-repository-config element specifies any
 * arbitrary configuration fragment for use in configuring the loader-repository
 * instance. The actual content of this element is specific to the
 * loaderRepositoryClass and the code parsing the element.
 * 
 * 
 */
public class LoaderRepositoryConfigTypeImpl<T> implements Child<T>,
	...
	// -------------------------------------------------------------------------------------||
	public LoaderRepositoryConfigType<T> setConfigParserClass(
