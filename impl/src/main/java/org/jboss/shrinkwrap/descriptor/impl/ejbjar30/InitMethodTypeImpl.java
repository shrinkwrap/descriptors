...
public class InitMethodTypeImpl<T> implements Child<T>, InitMethodType<T> {
	...
	public NamedMethodType<InitMethodType<T>> createMethod() {
		...
		NamedMethodType<InitMethodType<T>> createMethod = new NamedMethodTypeImpl<InitMethodType<T>>(
				this, "create-method", childNode, node);
		return createMethod;
	}
	...
	public NamedMethodType<InitMethodType<T>> beanMethod() {
		...
		NamedMethodType<InitMethodType<T>> beanMethod = new NamedMethodTypeImpl<InitMethodType<T>>(
