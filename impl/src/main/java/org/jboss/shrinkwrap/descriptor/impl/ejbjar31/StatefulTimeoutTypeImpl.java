 ...
 * 
 * 
 * The stateful-timeoutType represents the amount of time a stateful session
 * bean can be idle(not receive any client invocations) before it is eligible
 ...
 * 
 */
public class StatefulTimeoutTypeImpl<T> implements Child<T>,
