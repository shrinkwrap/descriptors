...
public class ServiceBeanTypeImpl<T> implements Child<T>, ServiceBeanType<T> {
	...
	public List<IconType<ServiceBeanType<T>>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<ServiceBeanType<T>> type = new IconTypeImpl<ServiceBeanType<T>>(
	...
	public EnvEntryType<ServiceBeanType<T>> envEntry() {
		return new EnvEntryTypeImpl<ServiceBeanType<T>>(this, "env-entry",
				childNode);
	}
	...
	public List<EnvEntryType<ServiceBeanType<T>>> getEnvEntryList() {
		...
		for (Node node : nodeList) {
			EnvEntryType<ServiceBeanType<T>> type = new EnvEntryTypeImpl<ServiceBeanType<T>>(
	...
	public EjbRefType<ServiceBeanType<T>> ejbRef() {
		return new EjbRefTypeImpl<ServiceBeanType<T>>(this, "ejb-ref",
				childNode);
	}
	...
	public List<EjbRefType<ServiceBeanType<T>>> getEjbRefList() {
		...
		for (Node node : nodeList) {
			EjbRefType<ServiceBeanType<T>> type = new EjbRefTypeImpl<ServiceBeanType<T>>(
	...
	public EjbLocalRefType<ServiceBeanType<T>> ejbLocalRef() {
		return new EjbLocalRefTypeImpl<ServiceBeanType<T>>(this,
	...
	public List<EjbLocalRefType<ServiceBeanType<T>>> getEjbLocalRefList() {
		...
		for (Node node : nodeList) {
			EjbLocalRefType<ServiceBeanType<T>> type = new EjbLocalRefTypeImpl<ServiceBeanType<T>>(
	...
	public ResourceRefType<ServiceBeanType<T>> resourceRef() {
		return new ResourceRefTypeImpl<ServiceBeanType<T>>(this,
	...
	public List<ResourceRefType<ServiceBeanType<T>>> getResourceRefList() {
		...
		for (Node node : nodeList) {
			ResourceRefType<ServiceBeanType<T>> type = new ResourceRefTypeImpl<ServiceBeanType<T>>(
	...
	public ResourceEnvRefType<ServiceBeanType<T>> resourceEnvRef() {
		return new ResourceEnvRefTypeImpl<ServiceBeanType<T>>(this,
	...
	public List<ResourceEnvRefType<ServiceBeanType<T>>> getResourceEnvRefList() {
		...
		for (Node node : nodeList) {
			ResourceEnvRefType<ServiceBeanType<T>> type = new ResourceEnvRefTypeImpl<ServiceBeanType<T>>(
	...
	public MessageDestinationRefType<ServiceBeanType<T>> messageDestinationRef() {
		return new MessageDestinationRefTypeImpl<ServiceBeanType<T>>(this,
	...
	public PersistenceContextRefType<ServiceBeanType<T>> persistenceContextRef() {
		return new PersistenceContextRefTypeImpl<ServiceBeanType<T>>(this,
	...
	public PersistenceUnitRefType<ServiceBeanType<T>> persistenceUnitRef() {
		return new PersistenceUnitRefTypeImpl<ServiceBeanType<T>>(this,
	...
	public List<PersistenceUnitRefType<ServiceBeanType<T>>> getPersistenceUnitRefList() {
		...
		for (Node node : nodeList) {
			PersistenceUnitRefType<ServiceBeanType<T>> type = new PersistenceUnitRefTypeImpl<ServiceBeanType<T>>(
	...
	public LifecycleCallbackType<ServiceBeanType<T>> postConstruct() {
		return new LifecycleCallbackTypeImpl<ServiceBeanType<T>>(this,
	...
	public List<LifecycleCallbackType<ServiceBeanType<T>>> getPostConstructList() {
		...
		for (Node node : nodeList) {
			LifecycleCallbackType<ServiceBeanType<T>> type = new LifecycleCallbackTypeImpl<ServiceBeanType<T>>(
	...
	public ServiceRefType<ServiceBeanType<T>> serviceRef() {
		return new ServiceRefTypeImpl<ServiceBeanType<T>>(this, "service-ref",
				childNode);
	}
	...
	public List<ServiceRefType<ServiceBeanType<T>>> getServiceRefList() {
		...
		for (Node node : nodeList) {
			ServiceRefType<ServiceBeanType<T>> type = new ServiceRefTypeImpl<ServiceBeanType<T>>(
	...
	public LocalBindingType<ServiceBeanType<T>> localBinding() {
		return new LocalBindingTypeImpl<ServiceBeanType<T>>(this,
				"local-binding", childNode);
	}
	...
	public List<LocalBindingType<ServiceBeanType<T>>> getLocalBindingList() {
		...
		for (Node node : nodeList) {
			LocalBindingType<ServiceBeanType<T>> type = new LocalBindingTypeImpl<ServiceBeanType<T>>(
					this, "local-binding", childNode, node);
			list.add(type);
		}
		return list;
	}
	...
	public RemoteBindingType<ServiceBeanType<T>> remoteBinding() {
		return new RemoteBindingTypeImpl<ServiceBeanType<T>>(this,
				"remote-binding", childNode);
	}
	...
	public List<RemoteBindingType<ServiceBeanType<T>>> getRemoteBindingList() {
		...
		for (Node node : nodeList) {
			RemoteBindingType<ServiceBeanType<T>> type = new RemoteBindingTypeImpl<ServiceBeanType<T>>(
					this, "remote-binding", childNode, node);
			list.add(type);
		}
		return list;
	}
	...
	public ClusterConfigType<ServiceBeanType<T>> clusterConfig() {
		...
		ClusterConfigType<ServiceBeanType<T>> clusterConfig = new ClusterConfigTypeImpl<ServiceBeanType<T>>(
				this, "cluster-config", childNode, node);
	...
	public AnnotationType<ServiceBeanType<T>> annotation() {
		return new AnnotationTypeImpl<ServiceBeanType<T>>(this, "annotation",
				childNode);
	}
	...
	public List<AnnotationType<ServiceBeanType<T>>> getAnnotationList() {
		...
		for (Node node : nodeList) {
			AnnotationType<ServiceBeanType<T>> type = new AnnotationTypeImpl<ServiceBeanType<T>>(
	...
	public PoolConfigType<ServiceBeanType<T>> poolConfig() {
		...
		PoolConfigType<ServiceBeanType<T>> poolConfig = new PoolConfigTypeImpl<ServiceBeanType<T>>(
	...
	public JndiRefType<ServiceBeanType<T>> jndiRef() {
		return new JndiRefTypeImpl<ServiceBeanType<T>>(this, "jndi-ref",
				childNode);
	}
	...
	public List<JndiRefType<ServiceBeanType<T>>> getJndiRefList() {
		...
		for (Node node : nodeList) {
			JndiRefType<ServiceBeanType<T>> type = new JndiRefTypeImpl<ServiceBeanType<T>>(
	...
	public PortComponentType<ServiceBeanType<T>> portComponent() {
		...
		PortComponentType<ServiceBeanType<T>> portComponent = new PortComponentTypeImpl<ServiceBeanType<T>>(
