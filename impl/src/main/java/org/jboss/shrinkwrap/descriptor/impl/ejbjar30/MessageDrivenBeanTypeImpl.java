 ...
 * - the optional message-driven bean's transaction management type. If it is
 * not defined, it is defaulted to Container. - an optional declaration of the
 * bean's message-destination-type - an optional declaration of the bean's
 ...
 * optional declaration of the bean's environment entries - an optional
 * declaration of the bean's EJB references - an optional declaration of the
 * bean's local EJB references - an optional declaration of the bean's web
 * service references - an optional declaration of the security identity to be
 * used for the execution of the bean's methods - an optional declaration of the
