...
public class ClusterConfigTypeImpl<T> implements Child<T>, ClusterConfigType<T> {
	...
	public ClusterConfigType<T> setHomeLoadBalancePolicy(
		...
		childNode.getOrCreate("home-load-balance-policy").text(
	...
	public ClusterConfigType<T> setSessionStateManagerJndiName(
		...
		childNode.getOrCreate("session-state-manager-jndi-name").text(
	...
	public ClusterConfigType<T> setBeanLoadBalancePolicy(
		...
		childNode.getOrCreate("bean-load-balance-policy").text(
