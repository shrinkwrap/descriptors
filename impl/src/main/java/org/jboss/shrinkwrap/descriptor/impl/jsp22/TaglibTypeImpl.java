 ...
 * 
 * 
 * The taglibType defines the syntax for declaring in the deployment descriptor
 * that a tag library is available to the application. This can be done to
 * override implicit map entries from TLD files and from the container.
 * 
 * 
 * 
 */
