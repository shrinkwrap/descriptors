...
public interface WebserviceDescriptionType<T> extends Child<T>
{
   ...
   public IconType<WebserviceDescriptionType<T>> setIcon(IconType<T> icon);
   ...
   public PortComponentType<WebserviceDescriptionType<T>> setPortComponent(PortComponentType<T> portComponent);
