 ...
 * 
 * 
 * The concurrency-management-typeType specifies the way concurrency is managed
 * for a singleton or stateful session bean.
 * 
...
public enum ConcurrencyManagementTypeType {
	...
	public static ConcurrencyManagementTypeType getFromStringValue(String value) {
		for (ConcurrencyManagementTypeType type : ConcurrencyManagementTypeType
				.values()) {
