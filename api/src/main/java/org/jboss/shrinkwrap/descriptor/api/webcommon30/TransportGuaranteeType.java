 ...
 * 
 * 
 * The transport-guaranteeType specifies that the communication between client
 * and server should be NONE, INTEGRAL, or CONFIDENTIAL. NONE means that the
 * application does not require any transport guarantees. A value of INTEGRAL
 ...
 * transmission. In most cases, the presence of the INTEGRAL or CONFIDENTIAL
