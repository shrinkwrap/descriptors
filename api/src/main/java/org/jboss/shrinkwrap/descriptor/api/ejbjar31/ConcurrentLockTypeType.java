 ...
 * 
 * 
 * The concurrent-lock-typeType specifies how the container must manage
 * concurrent access to a method of a Singleton bean with container-managed
 * concurrency.
 * 
 * The container managed concurrency lock type must be one of the following :
 * 
 * Read Write
 * 
 * 
