...
public class PersistenceUnitDefImpl extends PersistenceDescriptorImpl implements PersistenceUnitDef
{
   ...
   @Override
   public Property removeProperty(final String name)
   {
      if ((name == null) || name.trim().isEmpty())
      {
         throw new IllegalArgumentException("Name of property to remove must not be null or blank");
      }
      Node props = persistenceUnit.getSingle("properties");
   ...
   @Override
   public boolean removeProperty(final Property prop)
   {
      if (prop == null)
      {
         throw new IllegalArgumentException("Property to remove must not be null");
      }
