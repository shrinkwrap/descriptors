 ...
 * 
 * 
 * The result-type-mappingType is used in the query element to specify whether
 * an abstract schema type returned by a query for a select method is to be
 * mapped to an EJBLocalObject or EJBObject type.
 * 
