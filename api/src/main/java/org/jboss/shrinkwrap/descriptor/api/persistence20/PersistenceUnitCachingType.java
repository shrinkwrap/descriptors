...
public enum PersistenceUnitCachingType {
	_ALL("ALL"), _NONE("NONE"), _ENABLE_SELECTIVE("ENABLE_SELECTIVE"), _DISABLE_SELECTIVE(
			"DISABLE_SELECTIVE"), _UNSPECIFIED("UNSPECIFIED");
	...
	public static PersistenceUnitCachingType getFromStringValue(String value) {
		for (PersistenceUnitCachingType type : PersistenceUnitCachingType
				.values()) {
