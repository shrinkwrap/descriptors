 ...
 * 
 * 
 * The time-unit-typeType represents a time duration at a given unit of
 * granularity.
 * 
...
public enum TimeUnitTypeType {
	_DAYS("Days"), _HOURS("Hours"), _MINUTES("Minutes"), _SECONDS("Seconds"), _MILLISECONDS(
			"Milliseconds"), _MICROSECONDS("Microseconds"), _NANOSECONDS(
			"Nanoseconds");
