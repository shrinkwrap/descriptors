 ...
 * 
 * 
 * The res-authType specifies whether the Deployment Component code signs on
 * programmatically to the resource manager, or whether the Container will sign
 * on to the resource manager on behalf of the Deployment Component. In the
