...
{"interceptors", "decorators", "alternatives", "extensions"})
@XmlRootElement(name = "beans")
public class BeansModel implements SchemaModel
{
   ...
   {
      return BeansModel.class.getPackage().getAnnotation(XmlSchema.class).namespace();
   }
   ...
   public String getSchemaLocation()
   {
      ...
      return new StringBuilder().append(namespace).append(" ").append(namespace).append("/beans")
