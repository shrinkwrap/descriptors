...
/**
 * Helper class for creating queries (collections of {@link Pattern}s)
 * from String query expressions
 *
...
class Patterns
{
   ...
   /**
    * Creates a query collection of {@link Pattern}s from the specified
    * {@link String}-formed query expression
