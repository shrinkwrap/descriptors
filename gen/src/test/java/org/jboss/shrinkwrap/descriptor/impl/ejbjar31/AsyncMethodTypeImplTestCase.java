...
public class AsyncMethodTypeImplTestCase
{   
   @Test
   public void testNullArg() throws Exception
   {
      TestDescriptorImpl provider = new TestDescriptorImpl("test");
      AsyncMethodType<TestDescriptorImpl> type = new AsyncMethodTypeImpl<TestDescriptorImpl>(provider, "async-methodType", provider.getRootNode());
