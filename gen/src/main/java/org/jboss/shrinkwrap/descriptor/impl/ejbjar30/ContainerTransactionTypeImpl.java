 ...
 * 
 */
public class ContainerTransactionTypeImpl<T> implements Child<T>,
	...
	public MethodType<ContainerTransactionType<T>> method() {
		return new MethodTypeImpl<ContainerTransactionType<T>>(this, "method",
				childNode);
	}
	...
	public List<MethodType<ContainerTransactionType<T>>> getMethodList() {
		...
		for (Node node : nodeList) {
			MethodType<ContainerTransactionType<T>> type = new MethodTypeImpl<ContainerTransactionType<T>>(
	...
	public TransAttributeType getTransAttribute() {
		return TransAttributeType.getFromStringValue(childNode
				.textValue("trans-attribute"));
	}
