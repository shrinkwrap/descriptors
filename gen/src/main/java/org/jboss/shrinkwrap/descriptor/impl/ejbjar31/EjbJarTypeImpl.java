 ...
 * optional icon that contains a small and a large icon file name - an optional
 * module name. Only applicable to stand-alone ejb-jars or ejb-jars packaged in
 * an ear. Ignored if specified for an ejb-jar.xml within a .war. In that case,
 * standard .war module-name rules apply. - structural information about all
 * included enterprise beans that is not specified through annotations -
 * structural information about interceptor classes - a descriptor for container
 * managed relationships, if any. - an optional application-assembly descriptor
...
public class EjbJarTypeImpl<T> implements Child<T>, EjbJarType<T> {
	...
	public List<IconType<EjbJarType<T>>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<EjbJarType<T>> type = new IconTypeImpl<EjbJarType<T>>(
	...
	public EnterpriseBeansType<EjbJarType<T>> enterpriseBeans() {
		...
		EnterpriseBeansType<EjbJarType<T>> enterpriseBeans = new EnterpriseBeansTypeImpl<EjbJarType<T>>(
	...
	public InterceptorsType<EjbJarType<T>> interceptors() {
		...
		InterceptorsType<EjbJarType<T>> interceptors = new InterceptorsTypeImpl<EjbJarType<T>>(
				this, "interceptors", childNode, node);
		return interceptors;
	}
	...
	public RelationshipsType<EjbJarType<T>> relationships() {
		...
		RelationshipsType<EjbJarType<T>> relationships = new RelationshipsTypeImpl<EjbJarType<T>>(
				this, "relationships", childNode, node);
	...
	public AssemblyDescriptorType<EjbJarType<T>> assemblyDescriptor() {
		...
		AssemblyDescriptorType<EjbJarType<T>> assemblyDescriptor = new AssemblyDescriptorTypeImpl<EjbJarType<T>>(
