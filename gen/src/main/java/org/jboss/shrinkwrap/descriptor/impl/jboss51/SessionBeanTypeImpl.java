...
public class SessionBeanTypeImpl<T> implements Child<T>, SessionBeanType<T> {
	...
	public LocalBindingType<SessionBeanType<T>> localBinding() {
		return new LocalBindingTypeImpl<SessionBeanType<T>>(this,
	...
	public List<LocalBindingType<SessionBeanType<T>>> getLocalBindingList() {
		...
		for (Node node : nodeList) {
			LocalBindingType<SessionBeanType<T>> type = new LocalBindingTypeImpl<SessionBeanType<T>>(
	...
	public RemoteBindingType<SessionBeanType<T>> remoteBinding() {
		return new RemoteBindingTypeImpl<SessionBeanType<T>>(this,
	...
	public List<RemoteBindingType<SessionBeanType<T>>> getRemoteBindingList() {
		...
		for (Node node : nodeList) {
			RemoteBindingType<SessionBeanType<T>> type = new RemoteBindingTypeImpl<SessionBeanType<T>>(
	...
	public ClusterConfigType<SessionBeanType<T>> clusterConfig() {
		...
		ClusterConfigType<SessionBeanType<T>> clusterConfig = new ClusterConfigTypeImpl<SessionBeanType<T>>(
	...
	public AnnotationType<SessionBeanType<T>> annotation() {
		return new AnnotationTypeImpl<SessionBeanType<T>>(this, "annotation",
				childNode);
	}
	...
	public List<AnnotationType<SessionBeanType<T>>> getAnnotationList() {
		...
		for (Node node : nodeList) {
			AnnotationType<SessionBeanType<T>> type = new AnnotationTypeImpl<SessionBeanType<T>>(
	...
	public CacheConfigType<SessionBeanType<T>> cacheConfig() {
		...
		CacheConfigType<SessionBeanType<T>> cacheConfig = new CacheConfigTypeImpl<SessionBeanType<T>>(
				this, "cache-config", childNode, node);
		return cacheConfig;
	}
	...
	public PoolConfigType<SessionBeanType<T>> poolConfig() {
		...
		PoolConfigType<SessionBeanType<T>> poolConfig = new PoolConfigTypeImpl<SessionBeanType<T>>(
	...
	public JndiRefType<SessionBeanType<T>> jndiRef() {
		return new JndiRefTypeImpl<SessionBeanType<T>>(this, "jndi-ref",
				childNode);
	}
	...
	public List<JndiRefType<SessionBeanType<T>>> getJndiRefList() {
		...
		for (Node node : nodeList) {
			JndiRefType<SessionBeanType<T>> type = new JndiRefTypeImpl<SessionBeanType<T>>(
	...
	public PortComponentType<SessionBeanType<T>> portComponent() {
		...
		PortComponentType<SessionBeanType<T>> portComponent = new PortComponentTypeImpl<SessionBeanType<T>>(
