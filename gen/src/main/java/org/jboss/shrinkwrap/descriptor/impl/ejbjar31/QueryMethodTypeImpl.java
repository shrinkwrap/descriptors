 ...
 * 
 * The method-name element specifies the name of a finder or select method in
 * the entity bean's implementation class.
 * 
 * Each method-param must be defined for a query-method using the method-params
 * element.
 * 
 ...
 * Example:
 * 
 * <query> <description>Method finds large orders</description> <query-method>
 * <method-name>findLargeOrders</method-name> <method-params></method-params>
 * </query-method> <ejb-ql> SELECT OBJECT(o) FROM Order o WHERE o.amount &gt;
 * 1000 </ejb-ql> </query>
 * 
 * 
 * 
...
public class QueryMethodTypeImpl<T> implements Child<T>, QueryMethodType<T> {
	...
	public MethodParamsType<QueryMethodType<T>> methodParams() {
		...
		MethodParamsType<QueryMethodType<T>> methodParams = new MethodParamsTypeImpl<QueryMethodType<T>>(
