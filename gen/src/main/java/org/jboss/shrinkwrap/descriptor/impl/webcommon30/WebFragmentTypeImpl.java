...
public class WebFragmentTypeImpl<T> implements Child<T>, WebFragmentType<T> {
	...
	public ParamValueType<WebFragmentType<T>> contextParam() {
		return new ParamValueTypeImpl<WebFragmentType<T>>(this,
				"context-param", childNode);
	}
	...
	public List<ParamValueType<WebFragmentType<T>>> getContextParamList() {
		...
		for (Node node : nodeList) {
			ParamValueType<WebFragmentType<T>> type = new ParamValueTypeImpl<WebFragmentType<T>>(
	...
	public List<FilterType<WebFragmentType<T>>> getFilterList() {
		...
		for (Node node : nodeList) {
			FilterType<WebFragmentType<T>> type = new FilterTypeImpl<WebFragmentType<T>>(
	...
	public FilterMappingType<WebFragmentType<T>> filterMapping() {
		return new FilterMappingTypeImpl<WebFragmentType<T>>(this,
				"filter-mapping", childNode);
	}
	...
	public List<FilterMappingType<WebFragmentType<T>>> getFilterMappingList() {
		...
		for (Node node : nodeList) {
			FilterMappingType<WebFragmentType<T>> type = new FilterMappingTypeImpl<WebFragmentType<T>>(
	...
	public ListenerType<WebFragmentType<T>> listener() {
		return new ListenerTypeImpl<WebFragmentType<T>>(this, "listener",
				childNode);
	}
	...
	public List<ListenerType<WebFragmentType<T>>> getListenerList() {
		...
		for (Node node : nodeList) {
			ListenerType<WebFragmentType<T>> type = new ListenerTypeImpl<WebFragmentType<T>>(
	...
	public ServletType<WebFragmentType<T>> servlet() {
		return new ServletTypeImpl<WebFragmentType<T>>(this, "servlet",
				childNode);
	}
	...
	public List<ServletType<WebFragmentType<T>>> getServletList() {
		...
		for (Node node : nodeList) {
			ServletType<WebFragmentType<T>> type = new ServletTypeImpl<WebFragmentType<T>>(
	...
	public ServletMappingType<WebFragmentType<T>> servletMapping() {
		return new ServletMappingTypeImpl<WebFragmentType<T>>(this,
	...
	public List<ServletMappingType<WebFragmentType<T>>> getServletMappingList() {
		...
		for (Node node : nodeList) {
			ServletMappingType<WebFragmentType<T>> type = new ServletMappingTypeImpl<WebFragmentType<T>>(
	...
	public SessionConfigType<WebFragmentType<T>> sessionConfig() {
		return new SessionConfigTypeImpl<WebFragmentType<T>>(this,
				"session-config", childNode);
	}
	...
	public List<SessionConfigType<WebFragmentType<T>>> getSessionConfigList() {
		...
		for (Node node : nodeList) {
			SessionConfigType<WebFragmentType<T>> type = new SessionConfigTypeImpl<WebFragmentType<T>>(
	...
	public MimeMappingType<WebFragmentType<T>> mimeMapping() {
		return new MimeMappingTypeImpl<WebFragmentType<T>>(this,
				"mime-mapping", childNode);
	}
	...
	public List<MimeMappingType<WebFragmentType<T>>> getMimeMappingList() {
		...
		for (Node node : nodeList) {
			MimeMappingType<WebFragmentType<T>> type = new MimeMappingTypeImpl<WebFragmentType<T>>(
	...
	public WelcomeFileListType<WebFragmentType<T>> welcomeFileList() {
		return new WelcomeFileListTypeImpl<WebFragmentType<T>>(this,
	...
	public List<WelcomeFileListType<WebFragmentType<T>>> getWelcomeFileListList() {
		...
		for (Node node : nodeList) {
			WelcomeFileListType<WebFragmentType<T>> type = new WelcomeFileListTypeImpl<WebFragmentType<T>>(
	...
	public ErrorPageType<WebFragmentType<T>> errorPage() {
		return new ErrorPageTypeImpl<WebFragmentType<T>>(this, "error-page",
				childNode);
	}
	...
	public List<ErrorPageType<WebFragmentType<T>>> getErrorPageList() {
		...
		for (Node node : nodeList) {
			ErrorPageType<WebFragmentType<T>> type = new ErrorPageTypeImpl<WebFragmentType<T>>(
	...
	public JspConfigType<WebFragmentType<T>> jspConfig() {
		return new JspConfigTypeImpl<WebFragmentType<T>>(this, "jsp-config",
				childNode);
	}
	...
	public List<JspConfigType<WebFragmentType<T>>> getJspConfigList() {
		...
		for (Node node : nodeList) {
			JspConfigType<WebFragmentType<T>> type = new JspConfigTypeImpl<WebFragmentType<T>>(
	...
	public SecurityConstraintType<WebFragmentType<T>> securityConstraint() {
		return new SecurityConstraintTypeImpl<WebFragmentType<T>>(this,
	...
	public List<SecurityConstraintType<WebFragmentType<T>>> getSecurityConstraintList() {
		...
		for (Node node : nodeList) {
			SecurityConstraintType<WebFragmentType<T>> type = new SecurityConstraintTypeImpl<WebFragmentType<T>>(
	...
	public LoginConfigType<WebFragmentType<T>> loginConfig() {
		return new LoginConfigTypeImpl<WebFragmentType<T>>(this,
				"login-config", childNode);
	}
	...
	public List<LoginConfigType<WebFragmentType<T>>> getLoginConfigList() {
		...
		for (Node node : nodeList) {
			LoginConfigType<WebFragmentType<T>> type = new LoginConfigTypeImpl<WebFragmentType<T>>(
	...
	public SecurityRoleType<WebFragmentType<T>> securityRole() {
		return new SecurityRoleTypeImpl<WebFragmentType<T>>(this,
	...
	public List<SecurityRoleType<WebFragmentType<T>>> getSecurityRoleList() {
		...
		for (Node node : nodeList) {
			SecurityRoleType<WebFragmentType<T>> type = new SecurityRoleTypeImpl<WebFragmentType<T>>(
	...
	public MessageDestinationType<WebFragmentType<T>> messageDestination() {
		return new MessageDestinationTypeImpl<WebFragmentType<T>>(this,
	...
	public List<MessageDestinationType<WebFragmentType<T>>> getMessageDestinationList() {
		...
		for (Node node : nodeList) {
			MessageDestinationType<WebFragmentType<T>> type = new MessageDestinationTypeImpl<WebFragmentType<T>>(
	...
	public LocaleEncodingMappingListType<WebFragmentType<T>> localeEncodingMappingList() {
		return new LocaleEncodingMappingListTypeImpl<WebFragmentType<T>>(this,
	...
	public List<IconType<WebFragmentType<T>>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<WebFragmentType<T>> type = new IconTypeImpl<WebFragmentType<T>>(
	...
	public EnvEntryType<WebFragmentType<T>> envEntry() {
		return new EnvEntryTypeImpl<WebFragmentType<T>>(this, "env-entry",
				childNode);
	}
	...
	public List<EnvEntryType<WebFragmentType<T>>> getEnvEntryList() {
		...
		for (Node node : nodeList) {
			EnvEntryType<WebFragmentType<T>> type = new EnvEntryTypeImpl<WebFragmentType<T>>(
	...
	public EjbRefType<WebFragmentType<T>> ejbRef() {
		return new EjbRefTypeImpl<WebFragmentType<T>>(this, "ejb-ref",
				childNode);
	}
	...
	public List<EjbRefType<WebFragmentType<T>>> getEjbRefList() {
		...
		for (Node node : nodeList) {
			EjbRefType<WebFragmentType<T>> type = new EjbRefTypeImpl<WebFragmentType<T>>(
	...
	public EjbLocalRefType<WebFragmentType<T>> ejbLocalRef() {
		return new EjbLocalRefTypeImpl<WebFragmentType<T>>(this,
	...
	public List<EjbLocalRefType<WebFragmentType<T>>> getEjbLocalRefList() {
		...
		for (Node node : nodeList) {
			EjbLocalRefType<WebFragmentType<T>> type = new EjbLocalRefTypeImpl<WebFragmentType<T>>(
	...
	public ResourceRefType<WebFragmentType<T>> resourceRef() {
		return new ResourceRefTypeImpl<WebFragmentType<T>>(this,
	...
	public List<ResourceRefType<WebFragmentType<T>>> getResourceRefList() {
		...
		for (Node node : nodeList) {
			ResourceRefType<WebFragmentType<T>> type = new ResourceRefTypeImpl<WebFragmentType<T>>(
	...
	public ResourceEnvRefType<WebFragmentType<T>> resourceEnvRef() {
		return new ResourceEnvRefTypeImpl<WebFragmentType<T>>(this,
	...
	public List<ResourceEnvRefType<WebFragmentType<T>>> getResourceEnvRefList() {
		...
		for (Node node : nodeList) {
			ResourceEnvRefType<WebFragmentType<T>> type = new ResourceEnvRefTypeImpl<WebFragmentType<T>>(
	...
	public MessageDestinationRefType<WebFragmentType<T>> messageDestinationRef() {
		return new MessageDestinationRefTypeImpl<WebFragmentType<T>>(this,
	...
	public PersistenceContextRefType<WebFragmentType<T>> persistenceContextRef() {
		return new PersistenceContextRefTypeImpl<WebFragmentType<T>>(this,
	...
	public PersistenceUnitRefType<WebFragmentType<T>> persistenceUnitRef() {
		return new PersistenceUnitRefTypeImpl<WebFragmentType<T>>(this,
	...
	public List<PersistenceUnitRefType<WebFragmentType<T>>> getPersistenceUnitRefList() {
		...
		for (Node node : nodeList) {
			PersistenceUnitRefType<WebFragmentType<T>> type = new PersistenceUnitRefTypeImpl<WebFragmentType<T>>(
	...
	public LifecycleCallbackType<WebFragmentType<T>> postConstruct() {
		return new LifecycleCallbackTypeImpl<WebFragmentType<T>>(this,
	...
	public List<LifecycleCallbackType<WebFragmentType<T>>> getPostConstructList() {
		...
		for (Node node : nodeList) {
			LifecycleCallbackType<WebFragmentType<T>> type = new LifecycleCallbackTypeImpl<WebFragmentType<T>>(
	...
	public DataSourceType<WebFragmentType<T>> dataSource() {
		return new DataSourceTypeImpl<WebFragmentType<T>>(this, "data-source",
				childNode);
	}
	...
	public List<DataSourceType<WebFragmentType<T>>> getDataSourceList() {
		...
		for (Node node : nodeList) {
			DataSourceType<WebFragmentType<T>> type = new DataSourceTypeImpl<WebFragmentType<T>>(
	...
	public OrderingType<WebFragmentType<T>> ordering() {
		return new OrderingTypeImpl<WebFragmentType<T>>(this, "ordering",
				childNode);
	}
	...
	public List<OrderingType<WebFragmentType<T>>> getOrderingList() {
		...
		for (Node node : nodeList) {
			OrderingType<WebFragmentType<T>> type = new OrderingTypeImpl<WebFragmentType<T>>(
					this, "ordering", childNode, node);
			list.add(type);
		}
		return list;
	}
