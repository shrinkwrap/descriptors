 ...
 * 
 */
public class InterceptorBindingTypeImpl<T> implements Child<T>,
	...
	public InterceptorBindingType<T> setExcludeDefaultInterceptors(
		...
		childNode.getOrCreate("exclude-default-interceptors").text(
	...
	public Boolean isExcludeDefaultInterceptors() {
		return Strings.isTrue(childNode
				.textValue("exclude-default-interceptors"));
	}
	...
	public InterceptorBindingType<T> setExcludeClassInterceptors(
		...
		childNode.getOrCreate("exclude-class-interceptors").text(
	...
	public Boolean isExcludeClassInterceptors() {
		return Strings
				.isTrue(childNode.textValue("exclude-class-interceptors"));
	}
	...
	public NamedMethodType<InterceptorBindingType<T>> method() {
		...
		NamedMethodType<InterceptorBindingType<T>> method = new NamedMethodTypeImpl<InterceptorBindingType<T>>(
