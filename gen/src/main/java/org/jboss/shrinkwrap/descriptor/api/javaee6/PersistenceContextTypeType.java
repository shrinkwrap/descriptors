 ...
 * 
 * 
 * The persistence-context-typeType specifies the transactional nature of a
 * persistence context reference.
 * 
 * The value of the persistence-context-type element must be one of the
 * following: Transaction Extended
 * 
 * 
 * 
 */
public enum PersistenceContextTypeType {
	...
	public static PersistenceContextTypeType getFromStringValue(String value) {
		for (PersistenceContextTypeType type : PersistenceContextTypeType
				.values()) {
