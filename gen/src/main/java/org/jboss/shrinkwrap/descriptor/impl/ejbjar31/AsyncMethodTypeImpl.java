 ...
 *<br>
 *<br>
 * The async-methodType element specifies that a session <br> 
 * bean method has asynchronous invocation semantics. <br> 
 *<br>
 *<br>
 *
...
public class AsyncMethodTypeImpl<T> implements Child<T>, AsyncMethodType<T>
{
    ...
    * @return the current instance of {@link AsyncMethodType<T>} 
    */
   ...
   public MethodParamsType<AsyncMethodType<T>> methodParams()
   {
      ...
      MethodParamsType<AsyncMethodType<T>> methodParams = new MethodParamsTypeImpl<AsyncMethodType<T>>(this,
