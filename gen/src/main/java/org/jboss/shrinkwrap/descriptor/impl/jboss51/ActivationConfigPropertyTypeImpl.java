 ...
 * 
 */
public class ActivationConfigPropertyTypeImpl<T> implements Child<T>,
	...
	public ActivationConfigPropertyType<T> setActivationConfigPropertyName(
		...
		childNode.getOrCreate("activation-config-property-name").text(
	...
	public ActivationConfigPropertyType<T> setActivationConfigPropertyValue(
		...
		childNode.getOrCreate("activation-config-property-value").text(
