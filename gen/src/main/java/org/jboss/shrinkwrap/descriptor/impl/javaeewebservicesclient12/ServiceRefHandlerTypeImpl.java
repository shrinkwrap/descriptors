 ...
 * 
 */
public class ServiceRefHandlerTypeImpl<T> implements Child<T>,
	...
	public IconType<ServiceRefHandlerType<T>> icon() {
		return new IconTypeImpl<ServiceRefHandlerType<T>>(this, "icon",
				childNode);
	}
	...
	public List<IconType<ServiceRefHandlerType<T>>> getIconList() {
		...
		for (Node node : nodeList) {
			IconType<ServiceRefHandlerType<T>> type = new IconTypeImpl<ServiceRefHandlerType<T>>(
	...
	public ParamValueType<ServiceRefHandlerType<T>> initParam() {
		return new ParamValueTypeImpl<ServiceRefHandlerType<T>>(this,
				"init-param", childNode);
	}
	...
	public List<ParamValueType<ServiceRefHandlerType<T>>> getInitParamList() {
		...
		for (Node node : nodeList) {
			ParamValueType<ServiceRefHandlerType<T>> type = new ParamValueTypeImpl<ServiceRefHandlerType<T>>(
