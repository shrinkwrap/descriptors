 ...
 * 
 * 
 * The concurrent-methodType specifies information about a method of a bean with
 * container managed concurrency.
 * 
 * The optional lock element specifies the kind of concurrency lock asssociated
 * with the method.
 * 
 * The optional access-timeout element specifies the amount of time (in a given
 * time unit) the container should wait for a concurrency lock before throwing
 * an exception to the client.
 * 
 * 
 * 
 */
public class ConcurrentMethodTypeImpl<T> implements Child<T>,
	...
	public NamedMethodType<ConcurrentMethodType<T>> method() {
		...
		NamedMethodType<ConcurrentMethodType<T>> method = new NamedMethodTypeImpl<ConcurrentMethodType<T>>(
	...
	public ConcurrentLockTypeType getLock() {
		return ConcurrentLockTypeType.getFromStringValue(childNode
				.textValue("lock"));
	}
