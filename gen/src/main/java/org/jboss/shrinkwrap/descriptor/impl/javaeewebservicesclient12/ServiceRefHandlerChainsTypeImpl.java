 ...
 * 
 */
public class ServiceRefHandlerChainsTypeImpl<T> implements Child<T>,
	...
	public ServiceRefHandlerChainType<ServiceRefHandlerChainsType<T>> handlerChain() {
		return new ServiceRefHandlerChainTypeImpl<ServiceRefHandlerChainsType<T>>(
				this, "handler-chain", childNode);
	}
