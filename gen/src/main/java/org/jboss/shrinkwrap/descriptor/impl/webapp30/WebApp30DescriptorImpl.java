...
public List<String> getModuleNameList()
   ...
   public List<AbsoluteOrderingType<WebApp30Descriptor>> getAbsoluteOrderingList()
   {
      ...
      {
         AbsoluteOrderingType<WebApp30Descriptor>  type = new AbsoluteOrderingTypeImpl<WebApp30Descriptor>(this, "absolute-ordering", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<ParamValueType<WebApp30Descriptor>> getContextParamList()
   {
      ...
      for(Node node: nodeList)
      {
         ParamValueType<WebApp30Descriptor>  type = new ParamValueTypeImpl<WebApp30Descriptor>(this, "context-param", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<FilterMappingType<WebApp30Descriptor>> getFilterMappingList()
   {
      ...
      for(Node node: nodeList)
      {
         FilterMappingType<WebApp30Descriptor>  type = new FilterMappingTypeImpl<WebApp30Descriptor>(this, "filter-mapping", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<ServletMappingType<WebApp30Descriptor>> getServletMappingList()
   {
      ...
      for(Node node: nodeList)
      {
         ServletMappingType<WebApp30Descriptor>  type = new ServletMappingTypeImpl<WebApp30Descriptor>(this, "servlet-mapping", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<SessionConfigType<WebApp30Descriptor>> getSessionConfigList()
   {
      ...
      for(Node node: nodeList)
      {
         SessionConfigType<WebApp30Descriptor>  type = new SessionConfigTypeImpl<WebApp30Descriptor>(this, "session-config", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<MimeMappingType<WebApp30Descriptor>> getMimeMappingList()
   {
      ...
      for(Node node: nodeList)
      {
         MimeMappingType<WebApp30Descriptor>  type = new MimeMappingTypeImpl<WebApp30Descriptor>(this, "mime-mapping", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<WelcomeFileListType<WebApp30Descriptor>> getWelcomeFileListList()
   {
      ...
      for(Node node: nodeList)
      {
         WelcomeFileListType<WebApp30Descriptor>  type = new WelcomeFileListTypeImpl<WebApp30Descriptor>(this, "welcome-file-list", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<ErrorPageType<WebApp30Descriptor>> getErrorPageList()
   {
      ...
      for(Node node: nodeList)
      {
         ErrorPageType<WebApp30Descriptor>  type = new ErrorPageTypeImpl<WebApp30Descriptor>(this, "error-page", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<JspConfigType<WebApp30Descriptor>> getJspConfigList()
   {
      ...
      for(Node node: nodeList)
      {
         JspConfigType<WebApp30Descriptor>  type = new JspConfigTypeImpl<WebApp30Descriptor>(this, "jsp-config", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<SecurityConstraintType<WebApp30Descriptor>> getSecurityConstraintList()
   {
      ...
      for(Node node: nodeList)
      {
         SecurityConstraintType<WebApp30Descriptor>  type = new SecurityConstraintTypeImpl<WebApp30Descriptor>(this, "security-constraint", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<LoginConfigType<WebApp30Descriptor>> getLoginConfigList()
   {
      ...
      for(Node node: nodeList)
      {
         LoginConfigType<WebApp30Descriptor>  type = new LoginConfigTypeImpl<WebApp30Descriptor>(this, "login-config", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<SecurityRoleType<WebApp30Descriptor>> getSecurityRoleList()
   {
      ...
      for(Node node: nodeList)
      {
         SecurityRoleType<WebApp30Descriptor>  type = new SecurityRoleTypeImpl<WebApp30Descriptor>(this, "security-role", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<MessageDestinationType<WebApp30Descriptor>> getMessageDestinationList()
   {
      ...
      for(Node node: nodeList)
      {
         MessageDestinationType<WebApp30Descriptor>  type = new MessageDestinationTypeImpl<WebApp30Descriptor>(this, "message-destination", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<LocaleEncodingMappingListType<WebApp30Descriptor>> getLocaleEncodingMappingListList()
   {
      ...
      for(Node node: nodeList)
      {
         LocaleEncodingMappingListType<WebApp30Descriptor>  type = new LocaleEncodingMappingListTypeImpl<WebApp30Descriptor>(this, "locale-encoding-mapping-list", model, node);
         list.add(type);
      }
      return list;
   }
...
public List<String> getDisplayNameList()
   ...
   public List<EnvEntryType<WebApp30Descriptor>> getEnvEntryList()
   {
      ...
      for(Node node: nodeList)
      {
         EnvEntryType<WebApp30Descriptor>  type = new EnvEntryTypeImpl<WebApp30Descriptor>(this, "env-entry", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<EjbLocalRefType<WebApp30Descriptor>> getEjbLocalRefList()
   {
      ...
      for(Node node: nodeList)
      {
         EjbLocalRefType<WebApp30Descriptor>  type = new EjbLocalRefTypeImpl<WebApp30Descriptor>(this, "ejb-local-ref", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<ResourceRefType<WebApp30Descriptor>> getResourceRefList()
   {
      ...
      for(Node node: nodeList)
      {
         ResourceRefType<WebApp30Descriptor>  type = new ResourceRefTypeImpl<WebApp30Descriptor>(this, "resource-ref", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<ResourceEnvRefType<WebApp30Descriptor>> getResourceEnvRefList()
   {
      ...
      for(Node node: nodeList)
      {
         ResourceEnvRefType<WebApp30Descriptor>  type = new ResourceEnvRefTypeImpl<WebApp30Descriptor>(this, "resource-env-ref", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<MessageDestinationRefType<WebApp30Descriptor>> getMessageDestinationRefList()
   {
      ...
      for(Node node: nodeList)
      {
         MessageDestinationRefType<WebApp30Descriptor>  type = new MessageDestinationRefTypeImpl<WebApp30Descriptor>(this, "message-destination-ref", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<PersistenceContextRefType<WebApp30Descriptor>> getPersistenceContextRefList()
   {
      ...
      for(Node node: nodeList)
      {
         PersistenceContextRefType<WebApp30Descriptor>  type = new PersistenceContextRefTypeImpl<WebApp30Descriptor>(this, "persistence-context-ref", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<PersistenceUnitRefType<WebApp30Descriptor>> getPersistenceUnitRefList()
   {
      ...
      for(Node node: nodeList)
      {
         PersistenceUnitRefType<WebApp30Descriptor>  type = new PersistenceUnitRefTypeImpl<WebApp30Descriptor>(this, "persistence-unit-ref", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<LifecycleCallbackType<WebApp30Descriptor>> getPostConstructList()
   {
      ...
      for(Node node: nodeList)
      {
         LifecycleCallbackType<WebApp30Descriptor>  type = new LifecycleCallbackTypeImpl<WebApp30Descriptor>(this, "post-construct", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<LifecycleCallbackType<WebApp30Descriptor>> getPreDestroyList()
   {
      ...
      for(Node node: nodeList)
      {
         LifecycleCallbackType<WebApp30Descriptor>  type = new LifecycleCallbackTypeImpl<WebApp30Descriptor>(this, "pre-destroy", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   public List<DataSourceType<WebApp30Descriptor>> getDataSourceList()
   {
      ...
      for(Node node: nodeList)
      {
         DataSourceType<WebApp30Descriptor>  type = new DataSourceTypeImpl<WebApp30Descriptor>(this, "data-source", model, node);
         list.add(type);
      }
      return list;
   }
