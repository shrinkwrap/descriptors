 ...
 * 
 * 
 * The security-constraintType is used to associate security constraints with
 ...
 * 
 */
public class SecurityConstraintTypeImpl<T> implements Child<T>,
	...
	public WebResourceCollectionType<SecurityConstraintType<T>> webResourceCollection() {
		return new WebResourceCollectionTypeImpl<SecurityConstraintType<T>>(
				this, "web-resource-collection", childNode);
	}
