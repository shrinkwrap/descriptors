 ...
 * 
 * 
 * The res-sharing-scope type specifies whether connections obtained through the
 * given resource manager connection factory reference can be shared. The value,
 * if specified, must be one of the two following:
 * 
