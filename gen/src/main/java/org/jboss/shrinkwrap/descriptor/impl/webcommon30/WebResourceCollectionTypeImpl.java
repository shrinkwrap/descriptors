 ...
 * 
 * 
 * The web-resource-collectionType is used to identify the resources and HTTP
 * methods on those resources to which a security constraint applies. If no HTTP
 * methods are specified, then the security constraint applies to all HTTP
 * methods. If HTTP methods are specified by http-method-omission elements, the
 * security constraint applies to all methods except those identified in the
 * collection. http-method-omission and http-method elements are never mixed in
 * the same collection.
 * 
 ...
 * 
 */
public class WebResourceCollectionTypeImpl<T> implements Child<T>,
	...
	// -------------------------------------------------------------------------------------||
	public WebResourceCollectionType<T> setWebResourceName(
	...
	// isComplexType: false maxOccurs: -unbounded isAttribute: false
	// -------------------------------------------------------------------------------------||
	public WebResourceCollectionType<T> setHttpMethodOmission(
			String httpMethodOmission) {
		childNode.create("http-method-omission").text(httpMethodOmission);
		return this;
	}

	public WebResourceCollectionType<T> setHttpMethodOmissionList(
			String... values) {
		for (String name : values) {
