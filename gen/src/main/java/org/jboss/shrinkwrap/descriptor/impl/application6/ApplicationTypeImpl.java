...
public class ApplicationTypeImpl<T> implements Child<T>, ApplicationType<T> {
	...
	public GenericBooleanType getInitializeInOrder() {
		return GenericBooleanType.getFromStringValue(childNode
	...
	public EnvEntryType<ApplicationType<T>> envEntry() {
		return new EnvEntryTypeImpl<ApplicationType<T>>(this, "env-entry",
				childNode);
	}
	...
	public List<EnvEntryType<ApplicationType<T>>> getEnvEntryList() {
		...
		for (Node node : nodeList) {
			EnvEntryType<ApplicationType<T>> type = new EnvEntryTypeImpl<ApplicationType<T>>(
	...
	public EjbRefType<ApplicationType<T>> ejbRef() {
		return new EjbRefTypeImpl<ApplicationType<T>>(this, "ejb-ref",
				childNode);
	}
	...
	public List<EjbRefType<ApplicationType<T>>> getEjbRefList() {
		...
		for (Node node : nodeList) {
			EjbRefType<ApplicationType<T>> type = new EjbRefTypeImpl<ApplicationType<T>>(
	...
	public EjbLocalRefType<ApplicationType<T>> ejbLocalRef() {
		return new EjbLocalRefTypeImpl<ApplicationType<T>>(this,
	...
	public List<EjbLocalRefType<ApplicationType<T>>> getEjbLocalRefList() {
		...
		for (Node node : nodeList) {
			EjbLocalRefType<ApplicationType<T>> type = new EjbLocalRefTypeImpl<ApplicationType<T>>(
	...
	public ResourceRefType<ApplicationType<T>> resourceRef() {
		return new ResourceRefTypeImpl<ApplicationType<T>>(this,
	...
	public List<ResourceRefType<ApplicationType<T>>> getResourceRefList() {
		...
		for (Node node : nodeList) {
			ResourceRefType<ApplicationType<T>> type = new ResourceRefTypeImpl<ApplicationType<T>>(
	...
	public ResourceEnvRefType<ApplicationType<T>> resourceEnvRef() {
		return new ResourceEnvRefTypeImpl<ApplicationType<T>>(this,
	...
	public List<ResourceEnvRefType<ApplicationType<T>>> getResourceEnvRefList() {
		...
		for (Node node : nodeList) {
			ResourceEnvRefType<ApplicationType<T>> type = new ResourceEnvRefTypeImpl<ApplicationType<T>>(
	...
	public MessageDestinationRefType<ApplicationType<T>> messageDestinationRef() {
		return new MessageDestinationRefTypeImpl<ApplicationType<T>>(this,
	...
	public PersistenceContextRefType<ApplicationType<T>> persistenceContextRef() {
		return new PersistenceContextRefTypeImpl<ApplicationType<T>>(this,
	...
	public PersistenceUnitRefType<ApplicationType<T>> persistenceUnitRef() {
		return new PersistenceUnitRefTypeImpl<ApplicationType<T>>(this,
	...
	public List<PersistenceUnitRefType<ApplicationType<T>>> getPersistenceUnitRefList() {
		...
		for (Node node : nodeList) {
			PersistenceUnitRefType<ApplicationType<T>> type = new PersistenceUnitRefTypeImpl<ApplicationType<T>>(
	...
	public MessageDestinationType<ApplicationType<T>> messageDestination() {
		return new MessageDestinationTypeImpl<ApplicationType<T>>(this,
	...
	public List<MessageDestinationType<ApplicationType<T>>> getMessageDestinationList() {
		...
		for (Node node : nodeList) {
			MessageDestinationType<ApplicationType<T>> type = new MessageDestinationTypeImpl<ApplicationType<T>>(
	...
	public DataSourceType<ApplicationType<T>> dataSource() {
		return new DataSourceTypeImpl<ApplicationType<T>>(this, "data-source",
				childNode);
	}
	...
	public List<DataSourceType<ApplicationType<T>>> getDataSourceList() {
		...
		for (Node node : nodeList) {
			DataSourceType<ApplicationType<T>> type = new DataSourceTypeImpl<ApplicationType<T>>(
