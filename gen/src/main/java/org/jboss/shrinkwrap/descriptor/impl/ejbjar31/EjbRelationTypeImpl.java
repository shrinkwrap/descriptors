...
public List<String> getDescriptionList()
   ...
   public EjbRelationshipRoleType<EjbRelationType<T>> ejbRelationshipRole()
   {
      ...
      EjbRelationshipRoleType<EjbRelationType<T>> ejbRelationshipRole = new EjbRelationshipRoleTypeImpl<EjbRelationType<T>>(this, "ejb-relationship-role", childNode, node);
