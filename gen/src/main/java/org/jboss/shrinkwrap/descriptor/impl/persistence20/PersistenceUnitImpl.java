...
public class PersistenceUnitImpl<T> implements Child<T>, PersistenceUnit<T> {
	...
	public PersistenceUnit<T> setExcludeUnlistedClasses(
		...
		childNode.getOrCreate("exclude-unlisted-classes").text(
	...
	public PersistenceUnitCachingType getSharedCacheMode() {
		return PersistenceUnitCachingType.getFromStringValue(childNode
				.textValue("shared-cache-mode"));
	}
	...
	public PersistenceUnitValidationModeType getValidationMode() {
		return PersistenceUnitValidationModeType.getFromStringValue(childNode
				.textValue("validation-mode"));
	}
	...
	public Properties<PersistenceUnit<T>> properties() {
		...
		Properties<PersistenceUnit<T>> properties = new PropertiesImpl<PersistenceUnit<T>>(
				this, "properties", childNode, node);
		return properties;
	}
	...
	public PersistenceUnitTransactionType getTransactionType() {
		return PersistenceUnitTransactionType.getFromStringValue(childNode
