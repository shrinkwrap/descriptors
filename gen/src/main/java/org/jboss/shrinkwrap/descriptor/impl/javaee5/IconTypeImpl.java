 ...
 * file names for small and large GIF, JPEG, or PNG icon images used to
 * represent the parent element in a GUI tool.
 * 
 * The xml:lang attribute defines the language that the icon file names are
 * provided in. Its value is "en" (English) by default.
 * 
 * 
 * 
 */
