...
import org.jboss.shrinkwrap.descriptor.api.jboss51.ActivationConfigPropertyType;
 ...
 * 
 * 
 * The activation-configType defines information about the default configuration
 * properties of the message-driven bean in its operational environment. This
 * may include information about message acknowledgement, message selector,
 * expected destination type, etc.
 * 
 ...
 * 
 */
public class ActivationConfigTypeImpl<T> implements Child<T>,
	...
	public ActivationConfigPropertyType<ActivationConfigType<T>> activationConfigProperty() {
		return new ActivationConfigPropertyTypeImpl<ActivationConfigType<T>>(
				this, "activation-config-property", childNode);
	}
