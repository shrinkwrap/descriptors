...
public class Application6DescriptorImpl extends NodeProviderImplBase implements DescriptorNamespace<Application6Descriptor>, Application6Descriptor
{
   ...
   public SecurityRoleType<Application6Descriptor> securityRole()
   {
      ...
      SecurityRoleType<Application6Descriptor> securityRole = new SecurityRoleTypeImpl<Application6Descriptor>(this, "", model, node);
      return securityRole;
   }
   ...
   public EnvEntryType<Application6Descriptor> envEntry()
   {
      ...
      EnvEntryType<Application6Descriptor> envEntry = new EnvEntryTypeImpl<Application6Descriptor>(this, "", model, node);
      return envEntry;
   }
   ...
   public EjbLocalRefType<Application6Descriptor> ejbLocalRef()
   {
      ...
      EjbLocalRefType<Application6Descriptor> ejbLocalRef = new EjbLocalRefTypeImpl<Application6Descriptor>(this, "", model, node);
      return ejbLocalRef;
   }
   ...
   public ResourceRefType<Application6Descriptor> resourceRef()
   {
      ...
      ResourceRefType<Application6Descriptor> resourceRef = new ResourceRefTypeImpl<Application6Descriptor>(this, "", model, node);
      return resourceRef;
   }
   ...
   public ResourceEnvRefType<Application6Descriptor> resourceEnvRef()
   {
      ...
      ResourceEnvRefType<Application6Descriptor> resourceEnvRef = new ResourceEnvRefTypeImpl<Application6Descriptor>(this, "", model, node);
   ...
   public MessageDestinationRefType<Application6Descriptor> messageDestinationRef()
   {
      ...
      MessageDestinationRefType<Application6Descriptor> messageDestinationRef = new MessageDestinationRefTypeImpl<Application6Descriptor>(this, "", model, node);
   ...
   public PersistenceContextRefType<Application6Descriptor> persistenceContextRef()
   {
      ...
      PersistenceContextRefType<Application6Descriptor> persistenceContextRef = new PersistenceContextRefTypeImpl<Application6Descriptor>(this, "", model, node);
   ...
   public PersistenceUnitRefType<Application6Descriptor> persistenceUnitRef()
   {
      ...
      PersistenceUnitRefType<Application6Descriptor> persistenceUnitRef = new PersistenceUnitRefTypeImpl<Application6Descriptor>(this, "", model, node);
   ...
   public MessageDestinationType<Application6Descriptor> messageDestination()
   {
      ...
      MessageDestinationType<Application6Descriptor> messageDestination = new MessageDestinationTypeImpl<Application6Descriptor>(this, "", model, node);
   ...
   public DataSourceType<Application6Descriptor> dataSource()
   {
      ...
      DataSourceType<Application6Descriptor> dataSource = new DataSourceTypeImpl<Application6Descriptor>(this, "", model, node);
      return dataSource;
   }
