 ...
 * @author Dan Allen
 */
public class SecurityConstraintDef extends WebAppDescriptorImpl
{
   protected SecurityConstraint securityConstraint;
   
   public SecurityConstraintDef(WebAppModel webApp, SecurityConstraint securityConstraint)
   {
      super(webApp);
   ...
   public WebResourceCollectionDef webResourceCollection()
   {
      ...
      return new WebResourceCollectionDef(this.getSchemaModel(), securityConstraint, webResourceCollection);
   }
